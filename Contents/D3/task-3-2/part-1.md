...
- **한 줄 요약:** 좋은 프롬프트는 모델에 맡길 작업, 필요한 맥락, 원하는 출력 형식을 명확히 전달하며, 예제 수는 과제에 맞춰 선택합니다.
- **선수 지식:** 제로샷은 예시 없이 지시만 주는 방식이고, 퓨샷은 원하는 입출력 예시를 함께 주는 방식입니다.

### 자주 하는 오해

- **오해:** 긴 프롬프트나 사고의 사슬 지시를 추가하면 모든 문제의 답이 좋아진다.
  **바로잡기:** 관련 없는 내용은 혼란과 비용을 늘릴 수 있습니다. 대표 입력으로 간결한 지시·예시·형식을 비교 평가해야 합니다.

### 스스로 답하는 확인 질문

1. 출력 형식이 매번 달라지는 분류 작업에 템플릿과 퓨샷 예시가 어떻게 도움이 될까요?
2. 프롬프트 엔지니어링과 모델 전체 미세 조정의 비용·변경 범위는 어떻게 다른가요?

### 공식 범위와 출처

- 공식 Task 3.2의 프롬프트 구성과 제로샷·싱글샷·퓨샷·프롬프트 템플릿·사고의 사슬 기법 범위를 다룹니다.
