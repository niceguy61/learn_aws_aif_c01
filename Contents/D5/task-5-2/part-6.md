...
- **한 줄 요약:** AI 거버넌스는 필요한 기능에 맞는 가장 단순한 서비스 범위를 선택하고, 정책·교육·모니터링·정기 검토를 반복하는 운영 체계입니다.
- **선수 지식:** 책임 범위는 조직이 직접 설계·운영·통제해야 하는 데이터·모델·인프라·출력의 영역입니다.

### 자주 하는 오해

- **오해:** 더 많은 맞춤화와 더 복잡한 AI 서비스를 선택하면 항상 더 좋은 해결책이다.
  **바로잡기:** 맞춤화가 늘수록 데이터·보안·법적·운영 책임도 커집니다. 요구를 충족하는 가장 작은 책임 범위부터 검토합니다.

### 스스로 답하는 확인 질문

1. 완전관리형 AI 서비스, Bedrock RAG, 미세 조정 모델을 차례로 검토하는 이유는 무엇인가요?
2. AI 거버넌스 정책에 교육·모니터링·정기 검토가 모두 필요한 이유는 무엇인가요?

### 공식 범위와 출처

- **시험 핵심:** 공식 Task 5.2의 정책, 검토 주기·전략, 거버넌스 프레임워크, 투명성 표준과 팀 교육 요구 사항을 다룹니다.
