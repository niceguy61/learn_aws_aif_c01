...
- **한 줄 요약:** AI 위험 관리는 사용 사례와 이해관계자를 정하고, 위험의 가능도·영향을 평가한 뒤 통제로 낮추고 남은 잔존 위험을 검토하는 과정입니다.
- **선수 지식:** 내재적 위험은 통제 전의 위험이고, 잔존 위험은 통제를 적용한 뒤에도 남아 있는 위험입니다.

### 자주 하는 오해

- **오해:** 위험 점수가 낮아지면 더 이상 관리할 필요가 없다.
  **바로잡기:** 통제 후에도 잔존 위험이 남습니다. 사용 사례 변화, 새 위협, 데이터 변화에 따라 위험을 반복적으로 검토해야 합니다.

### 스스로 답하는 확인 질문

1. NIST AI RMF의 Govern, Map, Measure, Manage는 어떤 순환을 만들까요?
2. 복잡한 모델의 설명 가능성과 성능을 함께 검토해야 하는 이유는 무엇인가요?

### 공식 범위와 출처

- **시험 핵심:** 공식 Task 5.2의 거버넌스 프레임워크, 정책, 검토 전략 및 투명성 표준과 연결됩니다.
- **확인 필요:** 법·표준의 세부 적용 여부는 관할권과 시점에 따라 달라질 수 있으므로 시험 공식 범위와 별도로 최신 공식 자료를 확인합니다.
