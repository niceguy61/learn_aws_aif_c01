...
- **한 줄 요약:** Service Cards와 Model Cards는 모델의 용도·한계·평가 정보를 기록하고, Clarify·A2I·RLHF는 설명과 인간 피드백을 운영 흐름에 연결합니다.
- **선수 지식:** 인간 검토는 모델 결과를 사람이 확인하거나 수정하는 절차이며, 낮은 신뢰도 또는 높은 위험의 결과부터 우선 검토하도록 설계할 수 있습니다.

### 자주 하는 오해

- **오해:** 인간 검토나 RLHF를 사용하면 모델이 자동으로 공정하고 안전해진다.
  **바로잡기:** 인간 피드백도 기준·대표성·일관성에 영향을 받습니다. 검토자 지침, 감사 기록, 모델 평가와 운영 모니터링을 함께 설계해야 합니다.

### 스스로 답하는 확인 질문

1. AWS AI Service Card와 SageMaker Model Card는 각각 어떤 상황에서 활용하나요?
2. 낮은 신뢰도 결과를 A2I로 검토하고, 그 피드백을 다시 모델 개선에 쓰는 흐름을 설명할 수 있나요?

### 공식 범위와 출처

- **시험 핵심:** 공식 Task 4.2의 투명·설명 가능 모델 관련 도구, 인간 중심 설계와 사용자 피드백 메커니즘을 다룹니다.
- **AWS 실무 확장:** RLHF와 Ground Truth는 인간 피드백을 활용하는 연결 사례로 읽습니다.
