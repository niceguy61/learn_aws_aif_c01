...
| 항목 | 현재 확인값 |
|---|---|
| 시험 코드·등급 | `AIF-C01` · Foundational |
| 시험 시간·문항 | 90분 · 65문항 |
| 응시료 | 100 USD부터; 세금·환율·현지 통화 가격은 예약 시 확인 |
| 합격 기준 | scaled score 700; 정답률 70%로 단순 환산하지 않음 |
| 시험 방식 | Pearson VUE 시험 센터 또는 온라인 감독 시험 |
| 언어 | 현재 공식 자격증 페이지 기준 한국어 포함 다국어 지원 |
| ESL | 영어 응시 시 AWS FAQ의 추가 30분 ESL accommodation 경로 확인 |

가격·언어·ESL·예약 절차와 최신 변경 사항은 [상세 시험 안내](./guide.md)에서 확인하세요. 현재 자격증 페이지에는 Italian과 German 시험이 2026년 10월 15일 이후 종료될 예정이라는 안내가 있으므로, 응시 직전에 예약 화면을 다시 확인해야 합니다.
